...
class DS_More_Privacy_Options {
    ...
    function manage_sites_custom_column( $column_name, $blog_id ) {
		...
		$details = get_blog_details($blog_id);
			...
			echo '<br class="clear" />';// not sure what to do
	}
	...
	function add_privacy_options($options) {
		...
		?>
			<label class="checkbox" for="blog-private-1">
				<input id="blog-private-1" type="radio" name="blog_public" value="-1" <?php checked('-1', get_option('blog_public')); ?> /><?php esc_html__('Visible only to registered users of this network', $this->l10n_prefix); ?>
			</label>
			<br/>
			<label class="checkbox" for="blog-private-2">
				<input id="blog-private-2" type="radio" name="blog_public" value="-2" <?php checked('-2', get_option('blog_public')); ?> /><?php esc_html__('Visible only to registered users of this site', $this->l10n_prefix); ?>
			</label>
			<br/>
			<label class="checkbox" for="blog-private-3">
				<input id="blog-private-3" type="radio" name="blog_public" value="-3" <?php checked('-3', get_option('blog_public')); ?> /><?php esc_html__('Visible only to administrators of this site', $this->l10n_prefix); ?>
			</label>
			<?php
	}
